...
archetype_names.concat(archetypes_without_name)
...
# CHIMERA ARTMAGE START
deck = Deck.create!(advice: "Discard a random card before you draw your sixth! Don't forget about Mirror Swordknight and Cornfield Coatl negates in the graveyard. Don't forget about the two fusion monster's grave quick effects. Remember illusion monster's can't be destroyed or destroy others by battle", tier: 2, user: user)
deck.archetypes << Archetype.find_by!(name: "Chimera")
deck.archetypes << Archetype.find_by!(name: "Artmage")
